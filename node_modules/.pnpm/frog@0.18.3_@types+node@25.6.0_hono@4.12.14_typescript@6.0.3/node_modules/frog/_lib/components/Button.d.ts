...
export declare function ButtonMiniApp({ children, index, action, prompt, }: ButtonMiniAppProps): HtmlEscapedString;
export declare namespace ButtonMiniApp {
    var __type: string;
}
