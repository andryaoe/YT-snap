...
type RequestBodyToImageContextReturnType<env extends Env = Env, path extends string = string, input extends Input = {}, _state = env['State']> = Omit<FrameBaseContext<env, path, input, _state>, 'frameData' | 'verified' | 'status' | 'initialPath'>;
