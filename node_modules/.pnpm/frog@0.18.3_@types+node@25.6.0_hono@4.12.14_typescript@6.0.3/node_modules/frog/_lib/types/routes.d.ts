...
import type { CastActionContext, ComposerActionContext, FrameBaseContext, FrameContext, ImageContext, SignatureContext, TransactionContext } from './context.js';
...
export type ComposerActionHandler<E extends Env = any, P extends string = any, I extends Input = BlankInput> = (c: ComposerActionContext<E, P, I>) => HandlerResponse<ComposerActionResponse>;
...
export type Handler<E extends Env = any, P extends string = any, I extends Input = BlankInput, R extends HandlerResponse<any> = any> = (c: FrameBaseContext<E, P, I>) => R;
