...
export function ButtonMiniApp({ children, 
// @ts-ignore - private
index = 1, action, prompt, }) {
    return [
        _jsx("meta", { property: `fc:frame:button:${index}`, content: normalizeChildren(children), "data-value": buttonPrefix.miniApp }),
        _jsx("meta", { property: `fc:frame:button:${index}:action`, content: "link" }),
        _jsx("meta", { property: `fc:frame:button:${index}:target`, content: `https://warpcast.com/~/composer-action?url=${encodeURIComponent(action)}${prompt ? '&view=prompt' : ''}` }),
    ];
}
...
index = 1, }) {
    return [
        _jsx("meta", { property: `fc:frame:button:${index}`, content: normalizeChildren(children), "data-value": buttonPrefix.reset, "data-type": "reset" }),
    ];
}
